...
**/
$board = new board();
$board->init($ships, $hits, $miss, $success_hits, $attempts);
$status_msg = $board->enterCoord($coords);
$stats = $board->updateStats();

setcookie("harry_chow_battleship", json_encode($stats));
echo $board->outputHTML();
